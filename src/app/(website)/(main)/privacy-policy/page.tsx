  ...
  return (
    <div>
      ...
      <div className="py-8 md:py-12 container mx-auto">
        <title>Privacy Policy - The Unburdened Mind</title>
        <meta
          name="description"
          content="Privacy Policy for The Unburdened Mind"
        />
        ...
        <div className="mt-8 md:mt-12 px-4">
          <header className="text mb-8">
            ...
            <p className="text-gray-600">
              Welcome to The Unburdened Mind. Your privacy, trust, and peace of
              mind are deeply important to us. This Privacy Policy explains how
          ...
          <div className="prose prose-lg max-w-none">
            <div className="pt-6">
              ...
              <p className="text-gray-700 mb-4">
                At The Unburdened Mind, we collect information to provide a more
            ...
            <div className="pt-6">
              ...
              <p className="text-gray-700 mb-4">
                We use the information collected to enhance your experience and
                deliver reliable, high-quality services. Specifically, we use
                your information to:
              </p>
            ...
            <div className="pt-6">
              ...
              <p className="text-gray-700 mb-4">
                At The Unburdened Mind, you maintain full control over your
              ...
              <ul className="list-disc list-inside text-gray-700 space-y-2">
                ...
                <li>
                  Opt out of newsletters or marketing communications at any time
                </li>
            ...
            <div className="pt-6">
              ...
              <p className="text-gray-700">
                <strong>Email:</strong> support@theunburdenedmind.com <br />
                <strong>Phone:</strong> +1 (541) 377-4960 <br />
                <strong>Address:</strong> The Unburdened Mind, Portland, Oregon,
                USA
              </p>
            </div>
            ...
            <div className="pt-6">
              ...
              <p className="text-gray-700">
                By using The Unburdened Mind&apos;s website or engaging with our
