...
const OliverDropDown: React.FC<OliverDropDownProps> = ({
  ...
  return (
    <Select value={value} onValueChange={onChange}>
      <SelectTrigger className="bg-[#96C7FF] h-[60px] w-full rounded-full border-none outline-none cursor-pointer data-[placeholder]:text-[#0C2661] 
    ...
    data-[placeholder]:px-4">
      ...
      <SelectContent className="bg-white w-[90%] md:w-full h-[320px] ">
        {options.map((option) => (
